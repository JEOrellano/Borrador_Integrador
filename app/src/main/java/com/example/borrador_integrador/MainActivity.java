package com.example.borrador_integrador;
...
import com.example.borrador_integrador.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void datosUsuarioMenuHamburgueza() {
        ...
        SharedPreferences sp = getSharedPreferences(SignIn.SHARED_PREFERENCES_LOGIN_DATA, MODE_PRIVATE);
    ...
    private void limpairSp() {
        ...
        editor.remove(SignIn.SHARED_PREFERENCES_USERNAME);
        editor.apply();
    }
